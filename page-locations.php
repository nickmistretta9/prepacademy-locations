		...
		<div class="search-box">
			...
			<div class="location">
				...
				<div class="search">
					...
					<button class="btn-info"><i class="fa fa-search"></i></button>
				</div>
			</div>
		</div>
		<div class="locations-list">
			<div class="list ontario">
				...
				<div class="individual-location">
					...
					<div class="location"><i class="fa fa-map-marker"></i> Pickering, ON L1W 2S2</div>
					<div class="info">
						<div class="phone"><i class="fa fa-phone"></i> (226) 270-2062</div>
						<div class="website"><a href="" target="_blank"><i class="fa fa-picture-o"></i> Visit Website</a></div>
					</div>
					<hr>
					<div class="areas">
